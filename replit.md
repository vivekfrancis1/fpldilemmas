...
League Analysis caching: Added persistent localStorage caching for league IDs, automatically loading the last searched league on page load with clear functionality to reset cached data (implemented August 2025)
