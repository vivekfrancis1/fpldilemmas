...
- **FPL 2024/25 Rule Changes**: System fully implements new 2024/25 FPL rules: (1) Maximum 5 free transfers (up from 2), allowing strategic banking of unused transfers across gameweeks. (2) GW16 AFCON Free Transfer Top-Up: Managers who use all FTs in GW15 receive 5 FTs in GW16 (1 normal + 4 AFCON bonus); managers who bank transfers into GW16 receive banked FTs + 1 normal + 2 AFCON bonus (capped at 5). This special bonus accommodates the 2025 Africa Cup of Nations (December 21, 2025 - January 18, 2026) which affects key Premier League players during the festive period.
