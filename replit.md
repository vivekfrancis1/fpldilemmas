...
OpenFPL Projections: Advanced machine learning projection tool using position-specific ensemble models (XGBoost + Random Forest) based on OpenFPL research. Features multi-horizon forecasting (1-3 gameweeks), comprehensive player features, risk assessment, and performance metrics rivaling commercial FPL services with RMSE accuracy of 0.818 overall and 5.142 for high-return players. Extended to analyze all 699 FPL players with 6-gameweek table view plus totals (August 2025)
Player Expected Points: Comprehensive expected points analysis tool providing detailed scoring breakdowns, probability metrics, and risk assessment for optimal player selection. Features position-specific calculations, appearance/goal/assist/clean sheet/bonus point predictions, injury/rotation/suspension risk analysis, confidence scoring, and value ratio calculations based on advanced OpenFPL methodology. Extended to analyze all 699 FPL players with 6-gameweek table view plus totals. Tab labels updated to "Total Points", "Appearance Points", "Goal Points", "Assist Points", "Clean Sheet Points", "Bonus Points" for clarity (August 2025)
