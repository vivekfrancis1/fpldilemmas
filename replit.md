...
Player Defensive Contributions: New projection tool displaying CBIT metrics for defenders and CBITR metrics for midfielders/forwards (Clean sheets, Bonus, ICT index, Transfers, Red cards) with position-specific modeling and slate gradient theme for identifying consistent FPL performers (August 2025)
