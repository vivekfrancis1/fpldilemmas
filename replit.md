...
Defensive Contribution Analytics (2025/26 Season): Integrated new FPL API defensive data points including Defensive Contribution (composite defensive score), Tackles, Recoveries, Clearances/Blocks/Interceptions (CBI), and Starts metrics. These fields are exclusive to the current 2025/26 season and provide enhanced defensive player analysis with color-coded display and full sorting capabilities in the Player Statistics table.
