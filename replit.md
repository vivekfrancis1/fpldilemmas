...
Clean Sheet Formula: Updated to exponential decay calculation using CS = 100 × e^(-1.1 × xGA) for each gameweek. Formula creates mathematically accurate clean sheet percentages: strong defensive gameweeks (0.5 xGA) yield ~57.7% CS chance, average gameweeks (1.0 xGA) yield ~33.3% CS chance, tougher gameweeks (1.5 xGA) yield ~19.2% CS chance, poor defensive gameweeks (2.0 xGA) yield ~11.1% CS chance. Exponential relationship properly models real-world clean sheet probabilities (August 2025)
