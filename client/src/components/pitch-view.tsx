            ...
            return gks.length > 0 && (
              <div className="flex justify-center gap-0.5">
                {gks.map(player => {
                  ...
                  return (
                    <div key={player.element} className="flex flex-col items-center w-[19.5%]" data-testid={`pitch-player-${player.element}`}>
                    ...
                    <div key={player.element} className="flex flex-col items-center w-[19%] opacity-90" data-testid={`bench-player-${player.element}`}>
                      <div className="relative w-full">
                        <svg viewBox="0 0 403 302" className="w-full drop-shadow-md sm:drop-shadow-lg">
                          ...
                          <text x="202" y="225" fontSize="52" fontWeight="bold" textAnchor="middle" fill={textColor}>{player.event_points || 0}</text>
