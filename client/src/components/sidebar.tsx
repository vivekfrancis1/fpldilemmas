  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        ...
        { path: "/top50-managers", label: "Top 50 (Current Season)", icon: Trophy, description: "Current top 50 managers from the overall FPL league", popular: false, adminOnly: true },
