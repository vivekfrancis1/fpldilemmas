...
export default function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        { path: "/top25-managers", label: "Top 25 (All Time)", icon: Crown, description: "Elite Fantasy Premier League managers and their performance", popular: false, adminOnly: true },
        { path: "/content-creators", label: "Content Creators", icon: Users, description: "Track top FPL content creators and influencers", popular: false, adminOnly: true }
      ]
    },
    {
      section: "My FPL",
