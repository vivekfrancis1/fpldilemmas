...
export default function Sidebar({ isOpen, onToggle }: SidebarProps) {
  ...
  const navItems = [
    ...
    },
    {
      ...
      items: [
        { path: "/match-predictions", label: "Match Predictions", icon: Target, description: "Projected goals & clean sheets", popular: false },
    ...
    },
    {
      ...
      items: [
        ...
        { path: "/player-minutes", label: "Minutes", icon: Clock, description: "Expected minutes per gameweek, reallocation-aware", popular: false, adminOnly: true }
      ]
    },
    {
