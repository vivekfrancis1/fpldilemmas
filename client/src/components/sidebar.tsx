  ...
  const navItems = [
    {
      ...
      items: [
        ...
        { path: "/transfer-recommendations", label: "Transfer Recommendations", icon: ArrowRightLeft, description: "Get transfer suggestions to maximize points", popular: false },
