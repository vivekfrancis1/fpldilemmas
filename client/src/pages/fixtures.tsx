...
export default function Fixtures() {
  ...
  const getDifficultyColor = (difficulty: number) => {
    switch (difficulty) {
      case 1: return 'bg-green-400 text-white'; // Very Easy - Lighter Green (even easier on eyes)
      ...
      case 5: return 'bg-red-400 text-white'; // Very Hard - Lighter Red (even easier on eyes)
  ...
  const getTierColor = (tier: string) => {
    switch (tier) {
      ...
      case 'promoted': return 'bg-red-400 text-white';
      default: return 'bg-gray-300 text-gray-900';
    }
  };
                            ...
                            <tr key={team.id} className="border-b hover:bg-gray-50">
                              ...
                              {gameweeks.map(gw => {
                                ...
                                const getOpponentDefenseColor = (defenseTier: string) => {
                                  switch (defenseTier) {
                                    case 'elite': return 'bg-red-400 text-white'; // Very Hard (FDR 5) - lighter red
                                    ...
                                    case 'promoted': return 'bg-green-400 text-white'; // Very Easy (FDR 1) - lighter green
                                    default: return 'bg-gray-300 text-gray-900';
                                  }
                                };
