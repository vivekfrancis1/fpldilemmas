              ...
              <div className="flex flex-wrap gap-0.5 sm:gap-1">
                ...
                {teams.map(team => (
                  <button key={team}
                    ...
                    className={`chip-toggle rounded-full border text-xs font-medium px-2.5 sm:px-3 py-1 leading-none cursor-pointer transition-colors ${selectedTeam === team ? 'bg-indigo-100 text-indigo-700 border-indigo-300' : 'bg-gray-100 text-gray-500 border-gray-300'}`}>
                    {team}
                  </button>
                ))}
              </div>
          ...
          <div className="fpl-card-header">
            <h2 className="fpl-card-title">
              ...
              <button
                ...
                className={`shrink-0 inline-flex items-center gap-1 chip-toggle rounded-full border text-xs font-medium px-3 sm:px-3.5 py-1 leading-none cursor-pointer transition-colors ${showOpponent ? 'bg-blue-100 text-blue-700 border-blue-300' : 'bg-gray-100 text-gray-500 border-gray-300'}`}
              >
