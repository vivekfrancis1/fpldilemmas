      ...
      <div className="fpl-page-header">
        <div className="fpl-page-header-content">
          <div className="fpl-page-title">
            ...
            <h1>Player Defensive Contributions</h1><SeasonBadge season={viewMode === "past" ? (historySeason ?? PREVIOUS_SEASON) : undefined} />
          </div>
            ...
            <div>
              <div className="flex flex-wrap items-center justify-between gap-1 mb-1">
                ...
                <div className="flex flex-wrap items-center gap-1">
                  ...
                  <button onClick={() => setSelectedGameweeks(prev => new Set(gameweeks.filter(gw => !prev.has(gw))))} className="chip-toggle rounded-full border text-xs font-medium px-2.5 sm:px-3 py-1 leading-none cursor-pointer bg-orange-50 text-orange-700 border-orange-300" data-testid="button-invert-gameweeks">Invert</button>
                </div>
              </div>
            ...
            <Table>
              <TableHeader>
                <TableRow>
                  ...
                  <TableHead
                    className="px-1 md:px-3 py-2 md:py-3 text-center text-xs font-medium text-gray-500 uppercase tracking-wider bg-orange-50 font-semibold cursor-pointer hover:bg-orange-100 transition-colors w-[65px] min-w-[65px] sticky right-0 md:right-[65px] z-[5]"
