...
import TransferPlanner from "../components/transfer-planner";
...
export default function Transfers() {
  ...
  return (
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50/30 overflow-x-hidden">
        <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 py-4 sm:py-8">
          {/* Header Section */}
          ...
          <TransferPlanner data={bootstrapData} isLoading={isLoading} />
        </div>
      </div>
