...
// after this list was last scraped. Every managerId below now resolves to an unrelated
...
// standings populate post-GW1. Do not use these IDs for anything until re-scraped from
// fplresearch.com (or an equivalent source) after the season is underway.
...
export const TOP_25_MANAGERS: Top25ManagerEntry[] = [
  ...
  { rank: 7, name: "Ben Crellin", managerId: 6586 },
