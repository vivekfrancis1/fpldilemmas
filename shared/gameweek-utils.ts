...
/** How many gameweeks are shown by default when a projection page loads (e.g. GW29–34) */
export const PROJECTION_DEFAULT_WEEKS = 6;

/** Full calculation horizon — how many gameweeks APIs compute and serve, and how far the "End GW" dropdowns reach */
export const PROJECTION_TOTAL_WEEKS = 38;
